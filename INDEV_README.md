# scorpion OS v4.0 — indev release
...
scorpion is a hobby x86 OS built from scratch. no linux, no unix, no borrowed kernel. everything — bootloader, memory, filesystem, networking, graphics, shell — written by hand.
...
- 140+ shell commands
- In-kernel filesystem (ScorpionFS)
...
```
qemu-system-i386 -cdrom scorpion.iso -m 128M -device rtl8139,netdev=net0 -netdev user,id=net0
```
