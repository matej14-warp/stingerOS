/* scorpion OS - fs/partition.c
   MBR partition table detection and management              */
...
#define SECS_PER_MB 2048   /* 512-byte sectors per MiB */
...
const char *partition_type_name(uint8_t type){
    switch(type){
        ...
        case PART_TYPE_SFS:    return "ScorpionFS";
