...
- **fetch** — scorpion package manager, pulls packages from cdn.voided.uk

### filesystem
- **ScorpionFS (SFS)** — in-memory filesystem, full read/write
...
*scorpion OS by goober/modrejzralok — built on a potato, shipped anyway*
