...
static const char*posts[]={"just woke up. existential dread loading...","breaking: guy does thing. experts divided.","hot take: the kernel is mid","local man discovers bus error at 3am","poll: is segfault bussin or lowkey trash?","scorpion OS user discovers happiness not in RAM","thread: i love my computer (it has never let me down) (it let me down)",NULL};
